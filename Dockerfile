...
WORKDIR /go/src/github.com/johnc2k/evilginx2
...
COPY . /go/src/github.com/johnc2k/evilginx2
...
COPY --from=build /go/src/github.com/johnc2k/evilginx2/bin/evilginx /app/evilginx
